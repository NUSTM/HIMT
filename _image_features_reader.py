...
@Description: 
@Author: k.chen
@Date: 2019-09-16 09:35:29
@LastEditTime: 2019-11-22 11:03:16
'''
...
class ImageFeaturesH5Reader(object):
    ...
    def __init__(self, features_path: str, in_memory: bool = False):
        ...
        with self.env.begin(write=False) as txn: 
            ...
            item = pickle.loads(txn.get(self._image_ids[0]))
            texts = str(base64.b64decode(item['texts']), encoding='utf-8')
            print("--------------------")
            print(texts)
            print("--------------------")
        ...
        self.texts = [None] * len(self._image_ids)
    ...
    def __getitem__(self, image_id):
        ...
        return features, num_boxes, image_location, image_location_ori, texts
